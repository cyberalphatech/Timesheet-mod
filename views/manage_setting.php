        ...
        <ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked">
          ...
          foreach($tab as $gr){
            ...
            <a href="<?php echo html_entity_decode($url); ?>" <?php echo html_entity_decode($target); ?> data-group="<?php echo html_entity_decode($gr); ?>">
              ...
              elseif($gr == 'zkbio_time'){
                echo '<i class="fa-regular fa-calendar-days"></i> '._l('ts_zkbio_time'); 
              }
              else{
                echo _l($gr); 
              }
...
<?php if(!(strpos($viewuri,'admin/timesheets/setting?group=zkbio_time') === false)){
	require 'modules/timesheets/assets/js/setting/zkbio_times/manage_js.php';
}elseif(!(strpos($viewuri,'admin/timesheets/setting?group=zkbio_employee') === false)){
  require 'modules/timesheets/assets/js/setting/zkbio_employees/manage_js.php';
}
?>