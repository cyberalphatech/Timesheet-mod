...
foreach ($rResult as $aRow) {
 ...
 if (has_permission('table_workplace_management', '', 'view') || is_admin()) {
   $option .= '<a href="#" class="btn btn-primary text-primary" data-id="'. $aRow['id'] . '" data-staffid="'. $aRow[db_prefix().'timesheets_workplace_assign.staffid'] . '" data-workplace_id = "'.$aRow[db_prefix().'timesheets_workplace_assign.workplace_id'].'" onclick="edit_workplace_assign(this)">';
