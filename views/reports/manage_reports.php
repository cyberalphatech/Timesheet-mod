          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-4 border-right">
                ...
                <hr class="hr-10" />
                <p><a href="#" class="font-medium" onclick="init_report(this,'attendance_by_department'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('attendance_by_department'); ?></a></p>
                <hr class="hr-10" />
                <p><a href="#" class="font-medium" onclick="init_report(this,'attendance_by_workplace'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('attendance_by_workplace'); ?></a></p>
                <hr class="hr-10" />
                <p><a href="#" class="font-medium" onclick="init_report(this,'absences_by_department'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('absences_by_department'); ?></a></p>
                <hr class="hr-10" />
                <p><a href="#" class="font-medium" onclick="init_report(this,'absences_by_workplace'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('absences_by_workplace'); ?></a></p>
              </div>
              <!-- End chart report -->
              <div class="col-md-4">
                  ...
                  <div class="p8">
                    ...
                    <div class="form-group" id="report-time">
                      ...
                      <select class="selectpicker" name="months-report" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                        <option class="select_all_time" value=""><?php echo _l('report_sales_months_all_time'); ?></option>
            ...
            <div id="report" class="hide">
              ...
              <?php $this->load->view('reports/attendance_by_department.php'); ?>
              <?php $this->load->view('reports/attendance_by_workplace.php'); ?>
              <?php $this->load->view('reports/absences_by_department.php'); ?>
              <?php $this->load->view('reports/absences_by_workplace.php'); ?>
            </div>
          </div>
        </div>
      </div>
