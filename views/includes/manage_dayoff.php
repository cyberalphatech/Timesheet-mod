...
<div id="unexpected_break">
  <table class="table holiday-data-table" id="holiday-data-table">
   <thead>
    <tr>
      <th>ID</th>
    ...
    <div class="modal-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <br>
          <div class="checkbox">              
            <input type="checkbox" class="capability" name="repeat_by_year" id="repeat_by_year" value="1">
            <label for="repeat_by_year"><?php echo _l('automatically_repeat_by_year'); ?></label>
          </div>
        </div>
      </div>
    </div>
