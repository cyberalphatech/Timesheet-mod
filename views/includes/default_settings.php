	...
	<div class="col-md-12">
		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="allows_updating_check_in_time" id="allows_updating_check_in_time" value="1" <?php if($allows_updating_check_in_time == 1){ echo "checked"; } ?>>
						<label for="allows_updating_check_in_time"><?php echo _l('allows_updating_check_in_time'); ?></label>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="allows_to_choose_an_older_date" id="allows_to_choose_an_older_date" value="1" <?php if($allows_to_choose_an_older_date == 1){ echo "checked"; } ?>>
						<label for="allows_to_choose_an_older_date"><?php echo _l('allows_to_choose_an_older_date'); ?></label>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="allow_attendance_by_coordinates" id="allow_attendance_by_coordinates" value="1" <?php if($allow_attendance_by_coordinates == 1){ echo "checked"; } ?>>
						<label for="allow_attendance_by_coordinates"><?php echo _l('allow_attendance_by_coordinates'); ?></label>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="allow_attendance_by_route" id="allow_attendance_by_route" value="1" <?php if($allow_attendance_by_route == 1){ echo "checked"; } ?>>
						<label for="allow_attendance_by_route"><?php echo _l('allow_attendance_by_route'); ?></label>
					</div>
				</div>
			</div>			
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="auto_checkout" id="auto_checkout" value="1" <?php if($auto_checkout == 1){ echo "checked"; } ?>>
						<label for="auto_checkout"><?php echo _l('auto_checkout'); ?></label>
					</div>
					<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="send_notification_if_check_in_forgotten" id="send_notification_if_check_in_forgotten" value="1" <?php if($send_notification_if_check_in_forgotten == 1){ echo "checked"; } ?>>
						<label for="send_notification_if_check_in_forgotten"><?php echo _l('send_notification_if_check_in_forgotten'); ?></label>
					</div>
					<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="send_email_check_in_out_customer_location" id="send_email_check_in_out_customer_location" value="1" <?php if($send_email_check_in_out_customer_location == 1){ echo "checked"; } ?>>
						<label for="send_email_check_in_out_customer_location"><?php echo _l('send_email_to_customer_when_staff_check_in_out_at_customer_location'); ?></label>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<div class="checkbox">							
						<input type="checkbox" class="capability" name="allow_employees_to_create_work_points" id="allow_employees_to_create_work_points" value="1" <?php if($allow_employees_to_create_work_points == 1){ echo "checked"; } ?>>
						<label for="allow_employees_to_create_work_points"><?php echo _l('allow_employees_to_create_work_points'); ?></label>
					</div>
				</div>
			</div>
		</div>
