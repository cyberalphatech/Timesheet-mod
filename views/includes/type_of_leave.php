  ...
  <tbody>
    ...
    foreach($type_of_leave as $leave) {?>
      <tr>
        ...
        <td>
          <a href="#" class="btn btn-primary btn-icon text-primary" onclick="edit_type_of_leave(this,<?php echo html_entity_decode($leave['id']); ?>); return false" data-id="<?php echo html_entity_decode($leave['id']); ?>" data-type_name="<?php echo html_entity_decode($leave['type_name']); ?>" data-symbol="<?php echo html_entity_decode($leave['symbol']); ?>">
